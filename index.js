...
app.get("/", (req, res) => {
  ...
  res.send(`
    ...
    <head>
      ...
      <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Plus Jakarta Sans', sans-serif; }
        body {
          background: #09090b;
          background-image: radial-gradient(circle at 50% 0%, #2a0f22 0%, #09090b 70%);
          color: #f8fafc;
          display: flex;
        ...
        .card {
          ...
          width: 100%;
          text-align: center;
          box-shadow: 0 20px 40px rgba(255, 105, 180, 0.08), 0 20px 40px rgba(0, 0, 0, 0.6);
        }
        .badge {
          display: inline-flex;
          align-items: center;
    ...
    <body>
      <div class="card">
        <div class="badge">
          <span class="pulse">${isConnected ? '🩷' : '🤍'}</span>
          Queen-Anika
        </div>
